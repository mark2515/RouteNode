...
class PromptBuilder(private val openAiService: OpenAiService = OpenAiService()) {
    ...
    fun buildPrompt(routeNodes: List<RouteNodeInput>, distanceUnit: String = "km", responseLanguage: String = "English"): String {
        ...
        promptBuilder.append("Each stop must provide exactly one address.\n")
        ...
        promptBuilder.append("Location: Coquitlam Centre, Barnet Highway, Coquitlam, BC, Canada\n")
        ...
        promptBuilder.append("**Stop 1 — Near Coquitlam Centre (pizza restaurant within 2 $distanceUnitText)**\n")
        promptBuilder.append("Recommended Place:\n")
        promptBuilder.append("```\n")
        promptBuilder.append("Pazzo Pizza, 2929 Barnet Hwy #105, Coquitlam, BC V3B 1C9\n")
        promptBuilder.append("```\n\n")
        promptBuilder.append("Tips:\n")
        promptBuilder.append("- Pazzo Pizza is known for its thin crust and fresh ingredients.\n")
        promptBuilder.append("- They offer quick takeout if you're in a hurry.\n")
        promptBuilder.append("\n")
